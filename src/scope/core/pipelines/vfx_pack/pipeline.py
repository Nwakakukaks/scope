...
from .effects import chromatic_aberration, halftone, vhs_retro
...
class VFXPipeline(Pipeline):
    ...
    def __call__(self, **kwargs) -> dict:
        ...
        if kwargs.get("halftone_enabled", False):
            frames = halftone(
                frames,
                dot_size=kwargs.get("halftone_dot_size", 8),
                sharpness=kwargs.get("halftone_sharpness", 0.7),
            )
